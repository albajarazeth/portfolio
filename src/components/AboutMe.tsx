      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="aspect-square rounded-[40px] overflow-hidden clay-card">
              <div className="w-full h-full flex items-center justify-center text-[#4A148C] text-6xl font-bold bg-gradient-to-br from-pink-100 to-purple-100">
                AG
              </div>
            </div>
          </motion.div>
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="clay-card rounded-[40px] p-8">
              <p className="text-lg sm:text-xl text-[#333] leading-relaxed space-y-6">
                <span>
