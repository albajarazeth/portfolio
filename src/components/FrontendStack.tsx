...
const FrontendStack = () => {
  return (
    <section id="frontend" className="py-[120px] px-6 sm:px-8 lg:px-12 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #F0F9FF 0%, #F5F3FF 50%, #FDF2F8 100%)' }}>
